...
public:
    ...
    Sophus::SE3f TrackRGBDM(const cv::Mat &im, const cv::Mat &depthmap, const cv::Mat &mask, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), std::string filename="");
