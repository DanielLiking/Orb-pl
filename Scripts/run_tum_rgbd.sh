...
DATASET_BASE_FOLDER="$HOME/Dataset"
...
$DEBUG_PREFIX ../Examples$SUFFIX/RGB-D/rgbd_tum_dyna ../Vocabulary/ORBvoc.txt ../Examples$SUFFIX/RGB-D/$TUM_YAML $DATASET_PATH $DATASET_PATH/associations.txt #&> rgbd_tum.log
