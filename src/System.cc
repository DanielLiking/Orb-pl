...
Sophus::SE3f System::TrackRGBDM(const cv::Mat &im, const cv::Mat &depthmap, const cv::Mat &mask, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    Sophus::SE3f Tcw = mpTracker->GrabImageRGBDM(imToFeed,imDepthToFeed,imMaskToFeed,timestamp,filename);
